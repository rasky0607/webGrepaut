            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="card card-primary card-outline">
                        ...
                        <div class="card-body">
                            <form method="post" action="/Coche/editCoche/<?=$idcoche?>/<?=$idcliente?>">
                                ...
                                <div class="d-flex justify-content-center form_container">
                                    <div class="col-12 col-md-3">
                                        ...
                                        <div class="input-group mb-3">
                                            <input type="text" name="matricula" class="form-control input_user" value="<?=$matricula?>" placeholder="">
                                        </div>
                                        <div class="input-group mb-3">
                                            <input type="text" name="marca" class="form-control input_user" value="<?=$marca?>" placeholder="">
                                        </div>
                                        <div class="input-group mb-3">
                                            <input type="text" name="modelo" class="form-control input_user" value="<?=$modelo?>" placeholder="">
                                        </div>
