...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0 text-dark"> Editar <small>trabajo <?= $numerotrabajo?> de la reparación  <?= $idreparacion?> </small></h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="card card-primary card-outline">
                        ...
                        <div class="card-body">
                            <form method="post" action="/Reparacion/editServicioReparacion/<?= $idreparacion?>/<?= $numerotrabajo?>">
                                ...
                                <div class="d-flex justify-content-center form_container">
                                    ...
                                    <div class="input-group mb-3">
                                        <input type="number" step="0.01" name="precioModificado" class="form-control input_user" value="<?=$precioModificado?>" placeholder="0.00€">
                                    </div>
