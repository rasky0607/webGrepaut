                ...
                <div class="col-sm-12">
                    ...
                    <form method="post" action="/Servicio">
                        <div class="inputsfiltro">
                            <input name="cadena" class="form-control input_user inputsearch" placeholder="Nombre servicio" type="search" />
                        ...
                        <a href="/Servicio/createServicio" class="btn btn-success btn-sm newItem">Nuevo Servicio</a>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container -->
                ...
                <div class="col-lg-12">
                  ...
                  ?>
                                    <tr>
                                        ...
                                        <td><?= $item->precio ?>€</td>
                                        <td>
                                            <a href=<?= site_url('/editServicio/'.$item->id) ?>><img
                                                    title="Editar elemento" src="/assets/template/img/pencil.png"
                                                    width="30" height="30" /></a>
                                            &nbsp;&nbsp;&nbsp;
                                            <a href="<?= site_url('deleteServicio/'.$item->id) ?>"
